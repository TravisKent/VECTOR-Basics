...
public class JNCursorController : MonoBehaviour
{
    ...
    */
    ...
    void Update()
    {
        ...
        */
        ...
        Ray ray1 = new Ray(betterRay, PlayerOneCursor.transform.forward); Debug.DrawRay(ray1.origin, ray1.direction * 40, Color.blue );
        Ray ray3 = new Ray(Camera.main.transform.position, Camera.main.transform.forward); Debug.DrawRay(ray3.origin, ray3.direction * 20, Color.red );
        if(Input.GetKeyDown(KeyCode.Space)) 
        { Debug.Log("Spacebar pressed"); 
        //check if obhect is clicked on CheckHitObject(); 
        } 
