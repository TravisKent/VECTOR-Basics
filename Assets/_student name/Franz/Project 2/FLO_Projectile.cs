...
public class FLO_Projectile : MonoBehaviour
{
    /*
   ...
   void Update()
   {
    if(Input.GetKeyDown(KeyCode.Space))
    {
        ...
        m_Rigidbody.AddForce(new Vector3(Random.Range(-1*rangeMax), Random.Range(-1*rangeMax,rangeMax), Random.Range(-1*rangeMax,rangeMax))  *  m_Thrust );
    }
}
*/
